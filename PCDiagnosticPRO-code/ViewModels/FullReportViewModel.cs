...
{
    /// <summary>
    /// ViewModel pour l'écran "Rapport intégrale" : HUD vitre, sections, synthèse/détails.
    /// </summary>
    public class FullReportViewModel : ViewModelBase
    {
        private string _title = "RAPPORT INTÉGRALE";
        ...
        public double ReliabilityPercent
        {
            ...
            set => SetProperty(ref _reliabilityPercent, value);
        }
