...
namespace PCDiagnosticPro.Models
{
    ...
    public class DriverInventoryItem
    {
        ...
        [JsonPropertyName("isOldByAge")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public bool? IsOldByAge { get; set; }

        [JsonPropertyName("ageMonths")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public int? AgeMonths { get; set; }

        [JsonPropertyName("updateAvailability")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public string? UpdateAvailability { get; set; }

        [JsonPropertyName("updateAvailabilityReason")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public string? UpdateAvailabilityReason { get; set; }
