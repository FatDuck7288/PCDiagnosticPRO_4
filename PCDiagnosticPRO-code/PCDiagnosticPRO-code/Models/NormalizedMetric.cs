...
namespace PCDiagnosticPro.Models
{
    ...
    public class NormalizedMetric
    {
        ...
        /// <summary>
        /// Alias for reason to make missing-data semantics explicit in downstream consumers.
        /// Mirrors <see cref="Reason"/>.
        /// </summary>
        [JsonPropertyName("reasonIfMissing")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public string? ReasonIfMissing
        {
            get => Reason;
            set => Reason = value;
        }
