...
namespace PCDiagnosticPro.Models
{
    ...
    public class UdisReport
    {
        ...
        /// <summary>Fail-close reason code for machine-readable troubleshooting.</summary>
        public string FailCloseReasonCode { get; set; } = string.Empty;

        /// <summary>User-facing fail-close message (pedagogical, non-technical).</summary>
        public string FailCloseUserMessage { get; set; } = string.Empty;

        /// <summary>Explain score impact when fail-close is active.</summary>
        public string FailCloseImpact { get; set; } = string.Empty;

        /// <summary>Actionable next step for the user when fail-close is active.</summary>
        public string FailCloseAction { get; set; } = string.Empty;
