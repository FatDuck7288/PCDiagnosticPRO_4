...
Harden and sanitize the draft PowerShell script. Preserve IT-support intent: diagnostics, repair (SFC/DISM), updates (Windows Update), cleanup, driver checks.
...
STRICT TASK:
1) Remove dangerous or ambiguous commands. Do not remove safe IT patterns: SFC, DISM, Windows Update checks, Temp cleanup, Get-HotFix, service status/restart with checks.
