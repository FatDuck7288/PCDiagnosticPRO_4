...
namespace PCDiagnosticPro.Services.NetworkDiagnostics
{
    ...
    public class NetworkDiagnosticsCollector
    {
        ...
        private static readonly string[] DownloadTestUrls = {
            "https://speed.cloudflare.com/__down?bytes=10000000",      // 10 MB - primary
            "https://proof.ovh.net/files/10Mb.dat",      // 10 Mb = 1.25 MB - fallback
            "https://speed.hetzner.de/1MB.bin"       // 1 MB - last resort
        };
        ...
        private static readonly string[] UploadTestUrls = {
            ...
            "https://postman-echo.com/post"     // Tele2 - Europe (Sweden), fallback
        };
