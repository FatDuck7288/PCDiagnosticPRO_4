    ...
    public static class WmiThermalZoneFallback
    {
            ...
            double maxValidC = 115.0)
        {
            try
            {
                ...
                return (null, "WMI_ThermalZone", "ACPI ThermalZone vide; TemperatureProbe et ThermalZoneInformation non disponibles (mode sécurisé). Cette source ACPI reste un fallback et peut etre absente sur certains materiels.");
            }
            catch (Exception ex)
            {
